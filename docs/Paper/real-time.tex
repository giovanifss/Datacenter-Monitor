...
hazards which may occur and impact the availability. Fire is the most potential hazard which can create severe effects on 
data center and can occur in a data center by mechanical failure, intentional arson, or natural causes \cite{janpitak2011data}.
